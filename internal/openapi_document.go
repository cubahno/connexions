...
func NewSchemaFromKin(schema *openapi3.Schema, parseConfig *config.ParseConfig) *Schema {
	if parseConfig == nil {
...
func newSchemaFromKin(schema *openapi3.Schema, parseConfig *config.ParseConfig, refPath []string, namePath []string) *Schema {
	if schema == nil {
		return nil
	}
	...
	if merged.Type.Is(TypeArray) && items == nil {
...
func mergeKinSubSchemas(schema *openapi3.Schema) (*openapi3.Schema, string) {
	...
	if not != nil {
		...
		if resultNot != nil {
			...
			resultNot.Type = &openapi3.Types{TypeObject}
		}
