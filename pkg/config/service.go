...
// GenerateConfig controls what gets generated by the service command.
type GenerateConfig struct {
	// Server enables server/main.go generation when non-nil.
	// To enable: generate: { server: {} }
	Server *struct{} `yaml:"server,omitempty"`
}

// NewGenerateConfig creates a new GenerateConfig with default values.
func NewGenerateConfig() *GenerateConfig {
	return &GenerateConfig{
		// don't generate server by default
		Server: nil,
	}
}
...
// ValidateConfig defines the validation configuration for a service.
